...
`define VTB_TEST_FAIL(lineno, out, ref, port_name) \
    ...
    $display("- line number    : line %0d in grp_15_test_small_tb.v.cases", lineno); \
...
module grp_15_test_small_tb;
  ...
  spiflash
  #(
    .FILENAME ("grp_15_test_small.hex")
  )
  spiflash
  (
    .csb (flash_csb),
  ...
  initial begin
    $dumpfile("grp_15_test_small.vcd");
    $dumpvars(0, grp_15_test_small_tb);
    #1;
  ...
  initial begin
    ...
    // Start test
    `include "grp_15_test_small_tb.v.cases"
