//========================================================================
// grp_16_test_loopback_stream_tb
//========================================================================
...
`define VTB_TEST_FAIL(lineno, out, ref, port_name) \
    ...
    $display("- line number    : line %0d in grp_16_test_loopback_stream_tb.v.cases", lineno); \
...
module grp_16_test_loopback_stream_tb;
  ...
  spiflash
  #(
    .FILENAME ("grp_16_test_loopback_stream.hex")
  )
  spiflash
  (
    .csb (flash_csb),
  ...
  initial begin
    $dumpfile("grp_16_test_loopback_stream.vcd");
    $dumpvars(0, grp_16_test_loopback_stream_tb);
    #1;
  ...
  initial begin
    ...
    // Start test
    `include "grp_16_test_loopback_stream_tb.v.cases"
