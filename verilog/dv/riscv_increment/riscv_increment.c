...
//	i = 1;
    ...
    reg_mprj_io_2  = GPIO_MODE_MGMT_STD_OUTPUT;        // management output (SDI)       spi master
    reg_mprj_io_3  = GPIO_MODE_MGMT_STD_OUTPUT;        // management output (SCK)       spi master
    reg_mprj_io_4  = GPIO_MODE_MGMT_STD_OUTPUT;        // management output (CSB)       spi master
    reg_mprj_io_5  = GPIO_MODE_MGMT_STD_OUTPUT;        // management input  (UART Rx)
