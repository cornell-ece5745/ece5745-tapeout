//========================================================================
// grp_99_test_gcd_rtl_basic_3x9_tb
//========================================================================
...
`define VTB_TEST_FAIL(lineno, out, ref, port_name) \
    ...
    $display("- line number    : line %0d in grp_99_test_gcd_rtl_basic_3x9_tb.v.cases", lineno); \
...
module grp_99_test_gcd_rtl_basic_3x9_tb;
  ...
  spiflash
  #(
    .FILENAME ("grp_99_test_gcd_rtl_basic_3x9.hex")
  )
  spiflash
  (
    .csb (flash_csb),
  ...
  initial begin
    $dumpfile("grp_99_test_gcd_rtl_basic_3x9.vcd");
    $dumpvars(0, grp_99_test_gcd_rtl_basic_3x9_tb);
    #1;
  ...
  initial begin
    ...
    // Start test
    `include "grp_99_test_gcd_rtl_basic_3x9_tb.v.cases"
