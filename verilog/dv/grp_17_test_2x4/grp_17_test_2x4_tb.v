...
`define VTB_TEST_FAIL(lineno, out, ref, port_name) \
    ...
    $display("- line number    : line %0d in grp_17_test_2x4_tb.v.cases", lineno); \
...
module grp_17_test_2x4_tb;
  ...
  initial begin
    $dumpfile("grp_17_test_2x4.vcd");
    $dumpvars(0, grp_17_test_2x4_tb);
    #1;
  ...
  initial begin
    ...
    // Start test
    `include "grp_17_test_2x4_tb.v.cases"
