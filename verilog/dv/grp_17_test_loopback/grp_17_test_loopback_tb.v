...
`define VTB_TEST_FAIL(lineno, out, ref, port_name) \
    ...
    $display("- line number    : line %0d in grp_17_test_loopback_tb.v.cases", lineno); \
...
module grp_17_test_loopback_tb;
  ...
  spiflash
  #(
    .FILENAME ("grp_17_test_loopback.hex")
  )
  spiflash
  (
    .csb (flash_csb),
  ...
  initial begin
    $dumpfile("grp_17_test_loopback.vcd");
    $dumpvars(0, grp_17_test_loopback_tb);
    #1;
  ...
  initial begin
    ...
    // Start test
    `include "grp_17_test_loopback_tb.v.cases"
