...
`define VTB_TEST_FAIL(lineno, out, ref, port_name) \
    ...
    $display("- line number    : line %0d in grp_16_test_basic_msgs_tb.v.cases", lineno); \
...
module grp_16_test_basic_msgs_tb;
  ...
  spiflash
  #(
    .FILENAME ("grp_16_test_basic_msgs.hex")
  )
  spiflash
  (
    .csb (flash_csb),
  ...
  initial begin
    $dumpfile("grp_16_test_basic_msgs.vcd");
    $dumpvars(0, grp_16_test_basic_msgs_tb);
    #1;
  ...
  initial begin
    ...
    // Start test
    `include "grp_16_test_basic_msgs_tb.v.cases"
