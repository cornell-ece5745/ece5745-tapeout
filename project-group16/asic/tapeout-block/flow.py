...
def construct():
  ...
  parameters = {
    ...
    'design_path'     : f"{this_dir}/../sim/tapeout",
    'design_name'     : 'grp_16_SPI_TapeOutBlockRTL_32bits_5entries', 
    'clock_period'    : 2.0,
    'clk_port'        : 'clk',
    'reset_port'      : 'reset',
    'adk'             : adk_name,
    ...
    # VCS-sim
    'test_design_name': 'grp_16_SPI_TapeOutBlockRTL_32bits_5entries',
    'waveform'        : True,
    'input_delay'     : 0.05,
    'output_delay'    : 0.05,
    ...
    # PT Power
    'saif_instance'   : 'grp_16_SPI_TapeOutBlockRTL_32bits_5entries_tb/DUT',
