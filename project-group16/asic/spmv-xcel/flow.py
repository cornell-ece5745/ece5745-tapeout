...
#
# Info   : This flow file is for the SpmvXcel in isolation.
#
...
def construct():
  ...
  parameters = {
    ...
    'design_path'     : f"{this_dir}/../../sim/spmv_xcel",
    'design_name'     : 'SpmvXcelCtrlRTL',
    'clock_period'    : 3.0,
    'clk_port'        : 'clk',
    'reset_port'      : 'reset',
    'adk'             : adk_name,
    ...
    # VCS-sim
    'test_design_name': 'SpmvXcelCtrlRTL',
    'input_delay'     : 0.05,
    'output_delay'    : 0.05,
    ...
    # PT Power
    'saif_instance'   : 'SpmvXcelCtrlRTL_tb/DUT',
  }
