...
def test_addi_rand_delays():
  run_test( ProcFL, inst_addi.gen_random_test,
...
def test_slti_rand_delays():
  run_test( ProcFL, inst_slti.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_sltiu_rand_delays():
  run_test( ProcFL, inst_sltiu.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srai_rand_delays():
  run_test( ProcFL, inst_srai.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_srli_rand_delays():
  run_test( ProcFL, inst_srli.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_slli_rand_delays():
  run_test( ProcFL, inst_slli.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_lui_rand_delays():
  run_test( ProcFL, inst_lui.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
...
def test_auipc_rand_delays():
  run_test( ProcFL, inst_auipc.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3 )
