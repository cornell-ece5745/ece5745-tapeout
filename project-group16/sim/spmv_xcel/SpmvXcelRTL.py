...
class SpmvXcelVRTL( VerilogPlaceholder, Component ):
  ...
  def construct( s ):
    ...
    s.set_metadata( VerilogTranslationPass.explicit_module_name, 'SpmvXcelRTL' )
...
if rtl_language == 'pymtl':
  from .SpmvXcelPRTL import SpmvXcelPRTL as SpmvXcelRTL
elif rtl_language == 'verilog':
  SpmvXcelRTL = SpmvXcelRTL
else:
