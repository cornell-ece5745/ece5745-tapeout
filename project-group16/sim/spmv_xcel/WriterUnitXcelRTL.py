...
class WriterUnitXcelVRTL( VerilogPlaceholder, Component ):
  ...
  def construct( s ):
    ...
    s.set_metadata( VerilogTranslationPass.explicit_module_name, 'WriterUnitXcelRTL' )
...
if rtl_language == 'pymtl':
  from .WriterUnitXcelPRTL import WriterUnitXcelPRTL as WriterUnitXcelRTL
elif rtl_language == 'verilog':
  WriterUnitXcelRTL = WriterUnitXcelVRTL
else:
