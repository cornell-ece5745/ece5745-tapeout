...
class ReaderUnitXcelVRTL( VerilogPlaceholder, Component ):
...
if rtl_language == 'pymtl':
  from .ReaderUnitXcelPRTL import ReaderUnitXcelPRTL as ReaderUnitXcelRTL
elif rtl_language == 'verilog':
  ReaderUnitXcelRTL = ReaderUnitXcelVRTL
else:
