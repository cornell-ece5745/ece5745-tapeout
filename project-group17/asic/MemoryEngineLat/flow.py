...
def construct():
  ...
  parameters = {
    ...
    'design_path'     : f"{this_dir}/../../sim/systolic_accelerator/memory_engine",
    'design_name'     : 'MemoryEngineLatRTL',
    'clock_period'    : 50,
    'clk_port'        : 'clk',
    'reset_port'      : 'reset',
    'adk'             : adk_name,
    ...
    # VCS-sim
    'test_design_name': 'MemoryEngineLatRTL',
    'input_delay'     : 0.05,
    'output_delay'    : 0.05,
    ...
    # PT Power
    'saif_instance'   : 'MemoryEngineLatRTL_tb/DUT',
  }
