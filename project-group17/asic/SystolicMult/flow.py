...
def construct():
  ...
  parameters = {
    ...
    'design_path'     : f"{this_dir}/../../sim/systolic_accelerator/systolic_mult",
    'design_name'     : 'SystolicMultRTL',
    'clock_period'    : 50,
    'clk_port'        : 'clk',
    'reset_port'      : 'reset',
    'adk'             : adk_name,
    ...
    # VCS-sim
    'test_design_name': 'SystolicMultRTL',
    'input_delay'     : 0.05,
    'output_delay'    : 0.05,
    ...
    # PT Power
    'saif_instance'   : 'SystolicMultRTL_tb/DUT',
  }
