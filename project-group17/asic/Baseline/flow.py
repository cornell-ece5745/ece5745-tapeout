#=========================================================================
# Processor, Cache, Null Accelerator
#=========================================================================
# Author : Jack Brzozowski
# Date   : January 27th, 2022
#
# Once we get the cache working, we need to use ProcMemXcel instead of
# ProcXcel below.
...
def construct():
  ...
  parameters = {
    ...
    # VCS-sim
    'test_design_name': 'ProcXcel_null_rtl',
    'input_delay'     : 0.05,
    'output_delay'    : 0.05,
    ...
    # PT Power
    'saif_instance'   : 'ProcXcel_null_rtl_tb/DUT',
  }
