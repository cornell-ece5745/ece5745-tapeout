...
class SPI_TapeOutBlockVRTL_sv2v( VerilogPlaceholder, Component ):
  ...
  def construct( s ):
    ...
    s.set_metadata( VerilogTranslationPass.explicit_module_name, f'grp_17_SPI_TapeOutBlockRTL_32bits_5entries' )
    s.set_metadata( YosysTranslationPass.explicit_module_name,   f'grp_17_SPI_TapeOutBlockRTL_32bits_5entries' )
