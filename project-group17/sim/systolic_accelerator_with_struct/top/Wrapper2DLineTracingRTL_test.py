...
def make_very_long_msgs():
  ...
  # fix_answer = np.matmul(fix_data, fix_weight)
  fix_answer = []
  for i in range(2):
    tmp_lst = []
    for j in range(2):
  ...
  # print(fix_weight.shape(), fix_data.shape())
...
# read in data from files 
# DATAPATH = "/home/ja499/ece5745/project-group17/sim/systolic_accelerator/top/test_data.dat"
# WEIGHTPATH = "/home/ja499/ece5745/project-group17/sim/systolic_accelerator/top/test_weight.dat"
# initial_weight = np.genfromtxt(WEIGHTPATH, delimiter=",")
# initial_data = np.genfromtxt(DATAPATH, delimiter=",")
