...
class MemoryEngineVRTL( VerilogPlaceholder, Component ):
  ...
  def construct(s):
    ...
    s.set_metadata( VerilogTranslationPass.explicit_module_name, 'MemoryEngineRTL' )


# Import the appropriate version based on the rtl_language variable

if rtl_language == 'verilog':
  MemoryEngineRTL = MemoryEngineVRTL
else:
