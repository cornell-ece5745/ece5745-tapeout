...
class RegFileVRTL( VerilogPlaceholder, Component ):
  ...
  def construct( s ):
    ...
    s.set_metadata( VerilogTranslationPass.explicit_module_name, 'RegFileRTL' )
...
if rtl_language == 'pymtl':
  from .RegFilePRTL import RegFilePRTL as RegFileRTL
elif rtl_language == 'verilog':
  RegFileRTL = RegFileVRTL
else:
