...
def test_beq( name, test, cmdline_opts ):
...
def test_beq_rand_delays( cmdline_opts ):
  run_test( ProcRTL, inst_beq.gen_random_test,
...
def test_bne_rand_delays( cmdline_opts ):
  run_test( ProcRTL, inst_bne.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3, cmdline_opts=cmdline_opts )
...
def test_bge( name, test, cmdline_opts ):
  run_test( ProcRTL, test, cmdline_opts=cmdline_opts )
...
def test_bge_rand_delays( cmdline_opts ):
  run_test( ProcRTL, inst_bge.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3, cmdline_opts=cmdline_opts )
...
def test_bgeu( name, test, cmdline_opts ):
  run_test( ProcRTL, test, cmdline_opts=cmdline_opts )
...
def test_bgeu_rand_delays( cmdline_opts ):
  run_test( ProcRTL, inst_bgeu.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3, cmdline_opts=cmdline_opts )
...
def test_blt( name, test, cmdline_opts ):
  run_test( ProcRTL, test, cmdline_opts=cmdline_opts )
...
def test_blt_rand_delays( cmdline_opts ):
  run_test( ProcRTL, inst_blt.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3, cmdline_opts=cmdline_opts )
...
def test_bltu( name, test, cmdline_opts ):
  run_test( ProcRTL, test, cmdline_opts=cmdline_opts )
...
def test_bltu_rand_delays( cmdline_opts ):
  run_test( ProcRTL, inst_bltu.gen_random_test,
            src_delay=3, sink_delay=5, mem_stall_prob=0.5, mem_latency=3, cmdline_opts=cmdline_opts )
