...
# (i.e., your design is in IntMultVarLatPRTL) or set this variable to
# 'verilog' if you are using Verilog for your RTL design (i.e., your
# design is in IntMulVarLatVRTL).
...
class IntMulVarLatVRTL( VerilogPlaceholder, Component ):
...
if rtl_language == 'pymtl':
  from .IntMulVarLatPRTL import IntMulVarLatPRTL as IntMulVarLatRTL
elif rtl_language == 'verilog':
  IntMulVarLatRTL = IntMulVarLatVRTL
else:
