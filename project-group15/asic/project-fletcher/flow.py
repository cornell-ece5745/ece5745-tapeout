...
# flow.py 
#=========================================================================
# Author : Cecilio C. Tamarit, Tim Tran
# Date   : May 10th, 2022
#
...
def construct():
  ...
  parameters = {
    ...
    'design_path'     : "{}/../../sim/project/fletcher".format(this_dir),
    'design_name'     : 'Fletcher32UnitRTL', 
    'clock_period'    : 0.6,
    'clk_port'        : 'clk',
    'reset_port'      : 'reset',
    'adk'             : adk_name,
    ...
    # VCS-sim
    'test_design_name': 'Fletcher32UnitRTL',
    'input_delay'     : 0.05,
    'output_delay'    : 0.05,
    ...
    # PT Power
    'saif_instance'   : 'Fletcher32UnitRTL_tb/DUT',
  } 
  ...
  trunc_design_name = trunc_design_name.split("_", 1)[0]
