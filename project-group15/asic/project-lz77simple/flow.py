...
def construct():
  ...
  parameters = {
    ...
    'design_path'     : "{}/../../sim/project/lz77simple".format(this_dir),
    'design_name'     : 'LZ77UnitRTL',
    'clock_period'    : 0.6,
    'clk_port'        : 'clk',
    'reset_port'      : 'reset',
    'adk'             : adk_name,
    ...
    # PT Power
    'saif_instance'   : 'LZ77UnitRTL_tb/DUT',
  }
