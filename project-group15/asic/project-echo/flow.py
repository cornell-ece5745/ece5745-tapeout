...
def construct():
  ...
  parameters = {
    ...
    'design_path'     : "{}/../../sim/project/echo".format(this_dir),
    'design_name'     : 'EchoUnitRTL_noparam', 
    'clock_period'    : 0.6,
    'clk_port'        : 'clk',
    'reset_port'      : 'reset',
    'adk'             : adk_name,
    ...
    # VCS-sim
    'test_design_name': 'EchoUnitRTL_noparam',
    'input_delay'     : 0.05,
    'output_delay'    : 0.05,
    ...
    # PT Power
    'saif_instance'   : 'EchoUnitRTL_noparam_tb/DUT',
  } 
