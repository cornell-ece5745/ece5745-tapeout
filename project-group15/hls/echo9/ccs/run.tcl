...
# Read Design Files
solution file add [file join $sfd ../src/tb9-int.cc] -type C++
solution file add [file join $sfd ../src/echo9-int-ref.cc] -type C++
solution file add [file join $sfd ../src/echo9-int.cc] -type C++
go compile
...
directive set /echo9_int/in:rsc  -MAP_TO_MODULE ccs_ioport.ccs_in_wait
directive set /echo9_int/out:rsc -MAP_TO_MODULE ccs_ioport.ccs_out_wait
