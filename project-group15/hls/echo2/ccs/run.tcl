...
solution file add [file join $sfd ../src/echo2-int-ref.cc] -type C++
solution file add [file join $sfd ../src/echo2-int.cc] -type C++
go compile
...
directive set /echo_int/in:rsc  -MAP_TO_MODULE ccs_ioport.ccs_in_wait
directive set /echo_int/out:rsc -MAP_TO_MODULE ccs_ioport.ccs_out_wait
