...
# Read Design Files
solution file add [file join $sfd ../src/fletcher32-tb.cc] -type C++
solution file add [file join $sfd ../src/fletcher32-ref.c] -type C++
solution file add [file join $sfd ../src/fletcher32.c] -type C++
go compile
...
directive set /fletcher32/in:rsc  -MAP_TO_MODULE ccs_ioport.ccs_in_wait
directive set /fletcher32/out:rsc -MAP_TO_MODULE ccs_ioport.ccs_out_wait
